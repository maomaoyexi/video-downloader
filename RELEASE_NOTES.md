...
多平台视频下载工具 v1.9.5 WebUI 版于 2026-07-17 发布！本次更新完成了核心代码模块化，并集中增强直播识别、封面处理、批量下载、停止可靠性、配置存储、SSE 状态恢复和自动更新安全。主程序文件名统一为 `视频下载工具v1.9.5-GUI.exe`，原有设置、预设、下载记录及下载目录全部兼容，直接替换 exe 即可升级。
